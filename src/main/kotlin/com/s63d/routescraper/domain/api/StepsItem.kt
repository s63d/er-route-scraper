...
import com.s63d.routescraper.domain.api.Coordinate
                     ...
                     val polyline: Polyline)
{
    ...
    fun toDatabaseModel() : com.s63d.routescraper.domain.database.StepsItem {
        val points = decoder.decode(polyline.points).map {
            GeoJsonPoint(it.lng, it.lat)
        }
        val line = GeoJsonLineString(points)
        return com.s63d.routescraper.domain.database.StepsItem(duration, startLocation.toGeoJsonPoint(), distance, travelMode, endLocation.toGeoJsonPoint(), line)
    }
}